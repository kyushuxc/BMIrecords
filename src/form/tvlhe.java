 ...
 * @author Pejj
 */
public class tvlhe extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(tvlhe.class.getName());

    /**
     * Creates new form tvlhe
     */
    public tvlhe() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("TVL-HE BMI RECORDS");
  ...
  private void fetchUserByGrade(String grade) throws Exception {
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement(
            "SELECT * FROM student WHERE grade = ? AND strand = 'TVL-HE'"
        );
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error loading Grade " + grade + "TVL-HE students.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
...
private void filterTable(String searchText) {
    ...
    try {
        ...
        if (searchText == null || searchText.trim().isEmpty()) {
            ps = con.prepareStatement("SELECT * FROM student WHERE strand = 'TVL-HE'");
        } else {
            ps = con.prepareStatement(
                "SELECT * FROM student WHERE strand = 'TVL-HE' AND " +
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error loading TVL-HE students.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new tvlhe().setVisible(true));
    }
