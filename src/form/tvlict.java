 ...
 * @author Pejj
 */
public class tvlict extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(tvlict.class.getName());

    /**
     * Creates new form tvlict
     */
    public tvlict() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("TVL-ICT BMI RECORDS");
 ...
 private void fetchUserByGrade(String grade) throws Exception {
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement(
            "SELECT * FROM student WHERE grade = ? AND strand = 'TVL-ICT'"
        );
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error loading Grade " + grade + " TVL-ICT students.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
...
private void filterTable(String searchText) {
    ...
    try {
        ...
        if (searchText == null || searchText.trim().isEmpty()) {
            ps = con.prepareStatement("SELECT * FROM student WHERE strand = 'TVL-ICT'");
        } else {
            ps = con.prepareStatement(
                "SELECT * FROM student WHERE strand = 'TVL-ICT' AND " +
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error loading TVL-ICT students.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new tvlict().setVisible(true));
    }
