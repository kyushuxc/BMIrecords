...
public class abm extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(abm.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ABM BMI RECORDS");
 ...
 private void fetchUserByGrade(String grade) throws Exception {
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement(
            "SELECT * FROM student WHERE grade = ? AND strand = 'ABM'"
        );
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error loading Grade " + grade + " ABM students.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
...
private void filterTable(String searchText) {
    ...
    try {
        ...
        if (searchText == null || searchText.trim().isEmpty()) {
            ps = con.prepareStatement("SELECT * FROM student WHERE strand = 'ABM'");
        } else {
            ps = con.prepareStatement(
                "SELECT * FROM student WHERE strand = 'ABM' AND " +
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error loading ABM students.", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new abm().setVisible(true));
    }
